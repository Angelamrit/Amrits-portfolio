...
export const chef: ChefProfile = {
  ...
  timeline: [
    {
      year: "Pathankot",
      title: "A mother's kitchen in India",
  ...
  training: [
    {
      title: "Home",
      body: "The daily cooking of his mother in Pathankot, India, where “simple but good” became the rule.",
    },
    {
  ...
  philosophy: {
    ...
    body: [
      ...
      "His roots are traditional Indian, and he protects them. But Angel's menu travels, from the chaat of the street to slow-cooked regional dishes, all of it predominantly vegetarian and 100% Halal.",
